...
var nullStar1, OneStar, Stars, starimg;
var star1, star2;
var starDisplay;
...
function preload()
{
  ...
  nullStar1 = loadAnimation("empty.png");
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   restartButton = createImg("restart-256.png");
   restartButton.position(150,350);
